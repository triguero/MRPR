...
package org.apache.mahout.keel.Algorithms.Shared.Parsing;

import org.apache.mahout.keel.Algorithms.Fuzzy_Rule_Learning.Shared.Fuzzy.*;
...
public class ProcessConfig {
    ...
    /**
     * <p>
     * Sets the class member parFomatoNuevo with true if the data are specified in theorg.apache.mahout.keel.new format; false otherwise.
     * </p>
     * @param tokens tokens recover class connected to the configuration file.
     * @throws SyntaxError
     */
