 ...
 * </p>
 */
package org.apache.mahout.keel.Algorithms.SVM.C_SVM;
 ...
 * @throws IOException 
     */
    public void process(InstanceSet train, InstanceSet test, String header) throws IOException {
        double[] outputs;
        double[] outputs2;
        Instance neighbor;
        double dist, mean;
        ...
        try {
        	...
        	//for(int i=0; i< train.getNumInstances(); i++)
        		//System.out.print(train.getInstances()[i].getOutputRealValues(0)+", ");
            ...
            System.out.println("Ndatos: "+ndatos+" Nvariables: "+nvariables+ "nentradas: "+nentradas+" nsalidas: "+nsalidas);
            ...
            for (int i = 0; i < ndatos; i++) {
                ...
                for (int n = 0; n < Attributes.getInputNumAttributes(); n++) {
                   ...
                   // System.out.print(SVMp.y[i]+",");
                }
                SVMp.y[i] = Double.valueOf(inst.getOutputNominalValues(0));// inst.getAllOutputValues()[0];
                
              //  System.out.print(inst.getOutputNominalValues(0)+",");
		...
		org.apache.mahout.classifier.basic.utils.Utils.readHeader(header);
            ...
            for (int i = 0; i < ndatos; i++) {
                ...
                if (tipo != Attribute.NOMINAL) {
                	...
                	//System.out.print(Math.round(svm.svm_predict(svr, SVMn))+", ");
                    X[i][1] = new String(a.getNominalValue((int) Math.round(svm.
                            svm_predict(svr, SVMn))));
                }
                ...
                predicciones.add(Integer.valueOf(X[i][1]));
