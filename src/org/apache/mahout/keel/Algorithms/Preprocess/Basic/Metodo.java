...
public class Metodo {
	...
	public Metodo (String ficheroScript, InstanceSet train, Context context) {
		...
		try {
		  ...
		  System.err.println(e+" muero en la lectura del train");
		  System.exit(1);
		}
		...
		try {
		  ...
		  System.err.println(e+" muero en la lectura del test");
		  System.exit(1);
		}
		...
		this.context.progress();
		  ...
		  System.err.println(e+" muero en normalización");
		  System.exit(1);
		}
	...
	public Metodo (String ficheroScript, InstanceSet train, Context context, int strata) {
