...
package org.apache.mahout.keel.Algorithms.Preprocess.Feature_Selection;
...
import org.apache.mahout.keel.Algorithms.Preprocess.Basic.CheckException;
...
public class Datos {
    ...
    /** Creates a new instance of Datos */
    public Datos(InstanceSet train, int k, Context context) {
...
*/
    ...
    /** Creates a new instance of Datos 
     * @throws IOException */
    public Datos(InstanceSet train, InstanceSet test, int k, Context context, String header) throws IOException {

    	System.out.println(header);
        PGUtils.readHeader(header); // releer cabecera
...
*/
    ...
    private void normalizeTraining() throws CheckException {
        ...
        for (i=0; i<train.getNumInstances(); i++) {
           ...
           // caja = train.getInstance(i).g  //.getAllOutputValues();
            trainOutput[i] = train.getInstance(i).getOutputNominalValuesInt(0) ;//(int) caja[0];
    ...
    private void normalizeTest() throws CheckException{
        ...
        for (i=0; i<test.getNumInstances(); i++) {
            ...
            // caja = train.getInstance(i).g  //.getAllOutputValues();
            testOutput[i] = test.getInstance(i).getOutputNominalValuesInt(0) ;//(int) caja[0];
    ...
    public double LVO(boolean featuresVector[]){
        ...
        for(i=0; i<train.getNumInstances(); i++) {
         ...
         //   System.out.println(trainOutput[i]+ ","+(int)Math.round(media));
      ...
      //  System.out.println("errores: "+errores + "train.getNumInstances() "+train.getNumInstances());
