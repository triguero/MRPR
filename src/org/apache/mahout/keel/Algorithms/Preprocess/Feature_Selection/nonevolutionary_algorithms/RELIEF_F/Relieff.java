 ...
 * </p>
 */
package org.apache.mahout.keel.Algorithms.Preprocess.Feature_Selection.nonevolutionary_algorithms.RELIEF_F;
...
public class Relieff {
     ...
     * @param ficParametros is the name of the param file
     */
    public Relieff(InstanceSet train, int paramKNN, long seed, double relevanceThreshold, int numInstancesSampled) {
        ...
        params.seed=seed;
        params.relevanceThreshold=relevanceThreshold;
        params.numInstancesSampled=numInstancesSampled;
