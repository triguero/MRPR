...
public class ICPLGenerator extends PrototypeGenerator {
  ...
  boolean mapperOrReducer=true; // true means mapper, false reducer
  Context context;
  ...
  public ICPLGenerator(PrototypeSet _trainingDataSet, int nalg, String Method, int k, int Q, Context context)
  {
      super(_trainingDataSet);
      this.context = context;
      algorithmName="ICPL";
      
      mapperOrReducer = true;
      this.nAlg = nalg;
      this.method = Method;  
      this.k = k;
      this.Q = Q;
  ...
  public ICPLGenerator(Data _trainingDataSet, int nalg, String Method, int k, int Q, Context context)
  {
 ...
 */
  ...
  protected Prototype Merge(PrototypeSet S, boolean borders[], Prototype I, PrototypeSet merge){
	 ...
	 if (N!=null && borders!=null && I!=null){
	    // System.err.println("N index =" + N.getIndex());
	     //System.err.println("N output =" + N.getOutput(0));
	     //System.err.println("borders length =" + borders.length);
	     //System.err.println("Clase =" + Clase);
	     //System.err.println("borde? =" + borders[N.getIndex()]);
 ...
 * @throws Exception 
  ...
  public static void main(String[] args) throws Exception
  {
   ...
   //   ICPLGenerator generator = new ICPLGenerator(training, 1, "ENN", 4,40, null);
