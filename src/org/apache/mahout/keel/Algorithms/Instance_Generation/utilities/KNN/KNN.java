...
package org.apache.mahout.keel.Algorithms.Instance_Generation.utilities.KNN;
...
public class KNN
{
    ...
    public static Prototype _1nn(Prototype current, PrototypeSet dataSet)
    {
      ...
      //  System.out.println("****************");
       // current.print();
        Distance.setNumberOfInputs(current.numberOfInputs());
    ...
    public static Prototype _1nn(Prototype current, PrototypeSet dataSet, Context context)
    {
        Prototype nearestNeighbor = dataSet.get(0);
        int indexNN = 0;
        //double minDist = Distance.dSquared(current, nearestNeighbor);
    ...
    public static PrototypeSet knn(Prototype current, PrototypeSet dataSet, int k)
    {
        ...
        //current.print();
       // System.out.println("********** la primera del d");
        //dataSet.get(0).print(); 
        for(int i=0; i<k; ++i)
     ...
     * @return Number of prototypes well classificated
     */
    public static int [] classify(PrototypeSet training, PrototypeSet test, int k)
    {
...
/** 
    ...
    */  
    public static PrototypeSet getNearestNeighbors(Prototype current, PrototypeSet dataSet, int numberOfNeighbors)
    {
     ...
     //   System.out.println("Tamaño sorted: "+sorted.size());
        int _size = sorted.size();
        boolean full = false;
        int counter = 0;
        for(int i=0; i<_size  &&  !full; i++)
