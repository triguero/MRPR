...
public class IPLDEGenerator extends PrototypeGenerator  {
  ...
  public IPLDEGenerator(PrototypeSet _trainingDataSet, int neigbors, int maxIter, int iterSFGSS, int iterSFHC, double SF, double CR, double tau3, double tau4)
  {
  ...
  public IPLDEGenerator(Context context, Data _trainingDataSet, int neigbors, int maxIter, int iterSFGSS, int iterSFHC, double SF, double CR, double tau3, double tau4)
  {
  ...
  //     nominalPopulation.formatear(crossover);
    ...
    FitnessFi = accuracy(crossover,trainingDataSet);
  ...
  public PrototypeSet basicDE(PrototypeSet myTrain){ 
	  ...
	  //fitness = accuracy(nominalPopulation,trainingDataSet);
	   fitness = accuracy(myTrain,trainingDataSet);
	   ...
	   for(int j=0; j<5; j++){
		  ...
		  for(int i=0; i< this.iterBasicDE; i++){
			  ...
			  //double trialFitness =accuracy(nominalPopulation,trainingDataSet);
		       ...
		       double trialFitness =accuracy(modificados,trainingDataSet);
  ...
  public PrototypeSet reduceSet()
  {
	 ...
	 // double Fitness= accuracy(nominalPopulation,trainingDataSet);
		  ...
		  PrototypeSet tester;
			  ...
			  if(!claseMarcada[objetivo]){
				 ...
				 // solucion2.add(trainingDataSet.getFromClass(objetivo).getRandom()); // A�ado uno Y pruebo a optimizar.
				  ...
				  //double trialFitness= accuracy(nominalPopulation,trainingDataSet);
			       double trialFitness= accuracy(tester,trainingDataSet);
	  ...
	  // nominalPopulation = new PrototypeSet();
     // nominalPopulation.formatear(solucion);
	  double trialFitness= accuracy(solucion,trainingDataSet);
 ...
 * @throws Exception 
  ...
  public static void main(String[] args) throws Exception
  {
     ...
     //System.out.print(" swarm ="+swarm+"\n");
      ...
      IPLDEGenerator generator = new IPLDEGenerator(training, 1, 1000, 8, 20, 0.5, 0.9, 0.03, 0.07);
