...
package org.apache.mahout.keel.Algorithms.Instance_Generation.PSO;
...
public class PSOGenerator extends PrototypeGenerator {
  ...
  public PSOGenerator(PrototypeSet _trainingDataSet, int neigbors,int poblacion, int perc, int iteraciones, double c1, double c2, double vmax, double wstart, double wend)
  {
      ...
      this.numberOfPrototypes =  (int)Math.floor((_trainingDataSet.size())*ParticleSize/100.0);
      ...
      System.out.print("\nIsaac dice:  " + _trainingDataSet.size()+ " Swar= "+SwarmSize+ " Particle=  "+ ParticleSize + " Maxiter= "+ MaxIter+" Wend=  "+Wend+ "\n");
  }
