...
public class PrototypeGenerator {
    ...
    public static int kNearest = 1;
    public static String classifier = "NN";

    
    /** Condensed data */
    protected PrototypeSet generatedDataSet = null;
    
    protected Pair<PrototypeSet,PrototypeSet> generatedDataSet2 = null;
    ...
    public Pair<PrototypeSet, double[]> reduceSetFeatures() {
    	double[] weights= new double[trainingDataSet.get(0).numberOfInputs()];
    	Arrays.fill(weights,1.0);
    	Pair<PrototypeSet, double[]> nuevo = new Pair<PrototypeSet, double[]> (trainingDataSet.copy(),weights);
     ...
     * @throws Exception 
     */
    public final PrototypeSet execute() throws Exception {
        startTimer();
     ...
     * @return Reduced data set.
     */
    public final Pair<PrototypeSet,PrototypeSet> execute2() throws Exception {
        startTimer();
        Pair<PrototypeSet,PrototypeSet> resultSet = applyAlgorithm();
        stopTimer();
        generatedDataSet2 = resultSet;
        return resultSet;
    }
    ...
    /**
     * Execute the reduction of the data set. Note that this function, <i>au contraire</i> that reduceSet, uses timers.
     * @return Prediction in train and test.
     */
    public final PrototypeSet executeNB() {
        startTimer();
        PrototypeSet resultSet = reduceSetNB();
     ...
     * @return Reduced data set.
     */
    public final  Pair<PrototypeSet, double[]> executeFeatures() {
        startTimer();
        Pair<PrototypeSet, double[]> resultSet = reduceSetFeatures();
        ...
        stopTimer();
        generatedDataSet = resultSet.first();
        resultSet.first().applyThresholds();
     ...
     * @throws Exception 
     */
    public PrototypeSet generateReducedDataSet() throws Exception {
        return execute();
    }
