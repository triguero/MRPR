...
package org.apache.mahout.keel.Algorithms.Instance_Generation.LVQ;
...
public class LVQ3 extends LVQ2
{
    ...
    public LVQ3(Context context, Data tDataSet,int iter, double pcNprot, double alpha_0, double windowWidth, double epsilon)
    {
        super(new PrototypeSet(tDataSet), iter, pcNprot, alpha_0, windowWidth);        
    ...
    */    
    ...
    protected void correct(Prototype x, PrototypeSet tData)
    {
        ...
        double clase_1 = clase_x;
        
        if(dos!=null)
        	clase_1 = dos.getOutput(0);
