 ...
 * @version 1.0
 */
public class IPLDECSGenerator extends PrototypeGenerator {
  ...
  /**
   * Build a new IPLDECSGenerator Algorithm
   * @param t Original prototype set to be reduced.
   * @param perc Reduction percentage of the prototype set.
   */
  
  public IPLDECSGenerator(PrototypeSet _trainingDataSet, int neigbors, int poblacion, int maxIter, int iterSFGSS, int iterSFHC, double fl, double fu, double tau1, double tau2, double tau3, double tau4, int strag)
  {
  ...
  public IPLDECSGenerator(Context context, Data _trainingDataSet, int neigbors, int poblacion, int maxIter, int iterSFGSS, int iterSFHC, double fl, double fu, double tau1, double tau2, double tau3, double tau4, int strag)
  {
   ...
   */
  public IPLDECSGenerator(PrototypeSet t, Parameters parameters)
  {
      super(t, parameters);
  ...
  public PrototypeSet basicDE(PrototypeSet initial){ //, double claseOptimizar
	  ...
	  fitness[0] = accuracy(nominalPopulation,trainingDataSet);
  ...
  public PrototypeSet reduceSet()
  {
	 ...
	 // solucion.print();
	  solucion=basicDE(solucion); //Optimizacin Inicial
	 // solucion.print();
 ...
 * @throws Exception 
  ...
  public static void main(String[] args) throws Exception
  {
     ...
     //System.out.print(" swarm ="+swarm+"\n");
      ...
      IPLDECSGenerator generator = new IPLDECSGenerator(training, 1, 10, 100, 8, 20, 0.1, 0.9, 0.1,0.1,  0.03, 0.07, 3);
