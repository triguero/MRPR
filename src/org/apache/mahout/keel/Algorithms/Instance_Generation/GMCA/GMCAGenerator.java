...
package  org.apache.mahout.keel.Algorithms.Instance_Generation.GMCA;
...
import  org.apache.mahout.keel.Algorithms.Instance_Generation.MCA.*;
...
public class GMCAGenerator extends MCAGenerator
{
    ...
    public GMCAGenerator(PrototypeSet _trainingDataSet, Context context)
    {
        super(_trainingDataSet);
        algorithmName="GMCA";
