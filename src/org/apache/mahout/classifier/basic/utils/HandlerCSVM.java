...
import org.apache.mahout.keel.Algorithms.SVM.C_SVM.svmClassifier;
...
public class HandlerCSVM {
	...
	public HandlerCSVM(InstanceSet train, InstanceSet test, int clases, String Seed, String header) throws Exception{
		...
		for(int i = 0 ; i < this.numPartitions ; ++i){
			...
			model.process(train,test, header);
