...
import org.apache.mahout.classifier.df.mapreduce.resampling.HybridMapper;
import org.apache.mahout.classifier.df.mapreduce.resampling.HybridReducer;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class HybridBuilder {
	
  private static final Logger log = LoggerFactory.getLogger(HybridBuilder.class);
  ...
  protected HybridBuilder(Path dataPreprocessingPath, Path dataPath, Path datasetPath, Configuration conf) {	    
  ...
  public void build() throws IOException, ClassNotFoundException, InterruptedException {
	...
	Job job = new Job(conf, "hybrid builder");
